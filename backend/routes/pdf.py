...
async def render_pdf(
    ...
    try:
        ...
        print(
            ...
            f"template_id={template.meta.id} bytes={len(pdf_bytes)} user_id={current_user.id} pdf_used={quota['used']}"
        )
        ...
        try:
            ...
            try:
                ...
                print(
                    ...
                    f"resume_id={resume_id or '-'} template_id={template.meta.id} size={len(pdf_hex)/2} bytes user_id={current_user.id} "
                )
