...
{GREETING_STYLE_GUIDANCE}
4) 可带 0-1 个 emoji（如 👋 / ✨）。
5) 必须明确引导用户说「帮我创建一份模板默认简历」，并说明会在对话区自动创建并展示。
   示例：你好 👋 直接说「帮我创建一份模板默认简历」，我马上帮你在对话区创建并展示。
6) 不要引导「加载简历」「先看看简历」；若需提及已有简历，仅顺带一句可说「选择已有简历」。
...
直接说「帮我创建一份模板默认简历」，我会在对话区为你创建并展示。

已有简历？可以说「选择已有简历」加载，然后继续优化或诊断。"""
