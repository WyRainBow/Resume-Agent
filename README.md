...
### 初始界面
用户在左侧面板输入描述、支持一句话描述或完整简历文本

![初始界面](Latex%20简历演示/screenshots/1-初始界面.png)

### PDF 预览
右侧实时预览生成的 PDF、支持翻页和缩放

![PDF预览](Latex%20简历演示/screenshots/2-PDF预览完整.png)

### AI 生成简历
选择 AI 模型、点击生成、等待 AI 处理完成

![AI生成](Latex%20简历演示/screenshots/3-AI生成简历.png)
