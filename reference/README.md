...
| [2026-07-10-有灵魂感AI-Agent产品调研-工具编排与灵魂感机制.md](docs/2026-07-10-有灵魂感AI-Agent产品调研-工具编排与灵魂感机制.md) | 17+ 产品的机制层调研（Manus/OpenAI/Anthropic/Devin/Lovart/Kimi/MiniMax/Cursor/Replit 等）：工具编排、中间产物工作区、协议层人机确认；含「发邮件=撰写+确认+附件+发送」业界解法与对 Coco 的 8 条启示（拆原子工具、requires_approval 挂起、会话工作区、ask_user、事件信封收敛注册点等） |
