        ...
        <div className="border-t border-black p-4 space-y-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              {/* Header Font Family */}
              <div className="flex items-center gap-2">
                <span className="font-mono text-xs w-16 text-[#444850]">Headers:</span>
              ...
              {/* Body Font Family */}
              <div className="flex items-center gap-2">
                <span className="font-mono text-xs w-16 text-[#444850]">Body:</span>
                <div className="flex gap-1">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                <span className="font-mono text-xs text-[#444850]">Compact mode</span>
              </label>
              ...
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                <span className="font-mono text-xs text-[#444850]">Contact icons</span>
              </label>
            </div>
          </div>
          ...
          <div className="pt-2 border-t border-[#F1F2F5] space-y-3">
            <div>
              ...
              <div className="font-mono text-[10px] text-[#444850] space-y-1">
                <div>
                  Margins: {settings.margins.top}/{settings.margins.bottom}/{settings.margins.left}
                ...
                <div>Header font: {FONT_LABELS[settings.fontSize.headerFont]}</div>
                <div>Body font: {FONT_LABELS[settings.fontSize.bodyFont]}</div>
              </div>
              {settings.compactMode && (
                <div className="font-mono text-[10px] text-[#878E99] mt-2">
                  Compact mode: spacing ×0.6, line height ×0.92
                </div>
              )}
            </div>
