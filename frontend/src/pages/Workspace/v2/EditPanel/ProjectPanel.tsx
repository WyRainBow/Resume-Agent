    ...
    >
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        {onAIImport && (
          <button
            onClick={onAIImport}
            className="flex-1 px-4 py-2 rounded-lg bg-gradient-to-r from-purple-400 to-pink-500 hover:from-pink-500 hover:to-purple-400 text-white shadow-md transition-all duration-300 flex items-center justify-center gap-2"
          >
