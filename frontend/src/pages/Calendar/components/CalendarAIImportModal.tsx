      ...
      <div className="w-full max-w-[760px] rounded-2xl border border-slate-200 bg-white shadow-2xl">
        ...
        <div className="space-y-3 px-6 py-5">
          ...
          <textarea
            ...
            className="w-full rounded-xl border border-blue-200 bg-white px-4 py-3 text-[24px] leading-8 text-slate-900 outline-none focus:border-blue-400"
          />
          <p className="text-sm text-slate-500">提示：按 Tab 可自动补全示例句。</p>
          {errorMsg ? (
        ...
        <div className="flex items-center justify-end gap-3 border-t border-slate-200 px-6 py-4">
          <button type="button" onClick={onClose} className="rounded-xl border border-slate-300 px-6 py-2.5 text-lg text-slate-700 hover:bg-slate-100">
            取消
          </button>
          <button
            type="button"
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-blue-600 px-6 py-2.5 text-lg font-semibold text-white hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-60"
          >
